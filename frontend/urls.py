...
urlpatterns = [
    # Front end url 
    path('', views.frontend_views.home_page, name='home'),
    path('blank/', views.frontend_views.blank_page, name='blank'),
    path('checkout/', views.frontend_views.checkout_page, name='checkout'),
    path('product/', views.frontend_views.product_page, name='product'), 
    path('cart/', views.frontend_views.cart_page, name='cart'),
    path('categories/', views.frontend_views.all_categories_page, name='categories'),
    path('categories/<int:id>/<int:page>', views.frontend_views.all_products_by_category, name='view_products_by_category'),
    path('brands/', views.frontend_views.thuonghieu_page, name='brands'),
    path('brand/<int:id>/<int:page>', views.frontend_views.products_brand_page, name='brand_products'),
    path('search/', views.frontend_views.search_page, name='search'),
    path('login/', views.auth_views.login_page, name='login'),
    path('register/', views.auth_views.register_page, name='register'),
    path('product/<int:id>', views.frontend_views.product_page, name='product_detail'),
    path('logout/', views.auth_views.logout_page, name='logout'),
    path('add-to-cart/<int:id>', views.cart_payment_views.add_to_cart, name='add_to_cart'),
    path('remove-from-cart/<int:id>', views.cart_payment_views.remove_from_cart, name='remove_from_cart'),
    path('increase-cart-item/<int:id>', views.cart_payment_views.increase_cart_item, name='increase_cart_item'),
    path('decrease-cart-item/<int:id>', views.cart_payment_views.decrease_cart_item, name='decrease_cart_item'),
    path('payment/create/', views.cart_payment_views.create_payment, name='create_payment'),
    path('payment/momo/result/', views.cart_payment_views.payment_result, name='payment_result'),
    path('payment/ipn/', views.cart_payment_views.payment_ipn, name='payment_ipn'),
    path('profile/<int:user_id>', views.profile_views.update_user, name='profile'),
    path('profile/', views.profile_views.profile_page, name='profile_page'),
    path('profile/update/', views.profile_views.profile_page_update, name='profile_update'),
    ...
    # Admin Products (pagination via GET: ?page=&items=)
